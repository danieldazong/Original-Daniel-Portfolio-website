...
export default function Experience() {
  ...
  const progressPct =
    activeIndex < 0 ? 0 : ((activeIndex + 1) / EXPERIENCE_DATA.length) * 100;

  return (
            <section ref={sectionRef} id="experience" className="py-24 md:py-32 hero-grid-bg relative">
      {/* Faded "EXPERTISE" watermark — clipped locally so it never shifts the panel */}
      <div
        aria-hidden="true"
        className="pointer-events-none select-none absolute inset-x-0 top-0 md:top-2 z-0 flex justify-center overflow-hidden"
      >
        <span
          className="portfolio-watermark leading-none whitespace-nowrap"
          style={{
            transition:
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
                               ...
                               <div
          className="relative bg-surface/80 backdrop-blur-sm border border-border-custom shadow-sm p-8 md:p-14 lg:p-16"
                  style={{
          transition:
